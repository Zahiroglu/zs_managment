...
const colorPramary = Colors.green;
...
ThemeData darkTheme = ThemeData(
 ...
 LinearGradient bacgroundgradientTransparentLight = LinearGradient(
    ...
    colors: <Color>[Color(0xFFFFFFFF).withOpacity(0.2), Color(0xFFFFFFFF).withOpacity(0.2)]
);
 LinearGradient bacgroundgradientTransparentDark = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment(0.8, 0.0),
    colors: <Color>[Color(0xFF3A5160).withOpacity(0.5), Color(0xFF3A5160).withOpacity(0.5)]
);
