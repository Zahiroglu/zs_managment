...
class UserMainScreenController extends GetxController {
  ...
  void updateAllValues(ModelAllUsersLisanceUserCount selectedElement){
    getTotalInfoUsersFromApiService();
    ModelRequestUsersFilter modelRequestUsersFilter=ModelRequestUsersFilter(moduleId:selectedElement.id);
